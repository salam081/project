...
urlpatterns = [
    ...
    path('consumables_request_list',views.admin_consumables_list,name='admin_consumables_list'),
    path('consumables/<int:request_id>/', views.admin_consumable_detail, name='admin_consumable_detail'),
    path('guest-requests-list',views.guest_requests_list,name='guest_requests_list'),
    path('guest-request/<int:pk>/', views.guest_request_detail, name='guest_request_detail'),
