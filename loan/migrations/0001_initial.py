    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('approved', 'Approved'), ('rejected', 'Rejected'), ('Fullpaid', 'Fullpaid')], default='pending', max_length=20)),
                ...
                ('loan_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='loan.loantype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_receipt', models.ImageField(blank=True, null=True, upload_to='loan_receipts')),
        ...
        migrations.AddField(
            model_name='bankcode',
            name='bank_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='loan.bankname'),
        ),
        migrations.AddConstraint(
            model_name='loanrequest',
            constraint=models.CheckConstraint(check=models.Q(('approved_amount__lte', models.F('amount'))), name='approved_amount_not_greater_than_requested'),
        ),
